...
//Gernerated by Armature
static dBodyID body_big_box;
static dGeomID geom_big_box;
const float sides_big_box[3] = { 5, 5, 5 };
...
static void reset_bodies(void)
{
	...
	//Generated by Armature
	dBodySetPosition(body_big_box, 1.0, -0.5, 20.0);
	dBodySetLinearVel(body_big_box, 0, 0, 0);
	dBodySetAngularVel(body_big_box, 0, 0, 0);
...
void simLoop(int pause)
{
	...
	//Generated by Armature
	dsSetColor(1, 0, 0);
	dsDrawBox(dBodyGetPosition(body_big_box),
		dBodyGetRotation(body_big_box), sides_big_box);
...
int main(int argc, char **argv)
{
	...
	//Generated by Armature
	//Create Box_big_box
	body_big_box = dBodyCreate(world);
	geom_big_box = dCreateBox(0, 5, 5, 5);
	dGeomSetBody(geom_big_box, body_big_box);
	m.setBox(1, 1, 1, 1);
	dBodySetMass(body_big_box, &m);
	dBodySetPosition(body_big_box, 1.0, -0.5, 20.0);
	dSpaceAdd(space, geom_big_box);
	...
	//Generated by Armature
	unordered_map<dGeomID, int> no_collision_map_group1;
	no_collision_map_group1[geom_box1] = 0;
	no_collision_map_group1[geom_asdf] = 0;
	no_collision_map_group1[geom_big_box] = 0;

	no_collision_groups.push_back(no_collision_map_group1);
	//Generated by Armature
	unordered_map<dGeomID, int> no_collision_map_group2;
	no_collision_map_group2[geom_box3] = 0;
	no_collision_map_group2[geom_box4] = 0;
	no_collision_map_group2[geom_big_box] = 0;

	no_collision_groups.push_back(no_collision_map_group2);
